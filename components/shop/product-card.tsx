    ...
    <div className="group relative overflow-hidden rounded-lg border border-[#e2ded9] bg-white p-2 transition-all hover:shadow-md">
      ...
      {(isNew || onSale) && (
        <div className="absolute left-4 top-4 z-10">
          {onSale && (
            <Badge className="mb-2 bg-[#c17c60] text-white hover:bg-[#a86a51]">
              {discount}% OFF
            </Badge>
          )}
          {isNew && (
            <Badge className="bg-[#e9e5e0] text-[#6b6963] hover:bg-[#e9e5e0]">
              New
            </Badge>
          )}
        </div>
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {originalPrice && (
            <p className="text-sm text-[#6b6963] line-through">
